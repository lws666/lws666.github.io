...
export const siteConfig: SiteConfig = {
	title: "lws",
	subtitle: "blog",
	siteURL: "www.lwsnb.dpdns.org/", // 请替换为你的站点URL，以斜杠结尾
	...
	navbarTitle: {
		...
		icon: "https://img.lwsnb.dpdns.org/file/1770349026189_image_download_1770182784915.jpg",
		// 网站Logo图片路径
		logo: "https://img.lwsnb.dpdns.org/file/1770349026189_image_download_1770182784915.jpg",
	},
	...
	bilibili: {
		vmid: "3493115176422328", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				...
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/3493115176422328",
					external: true,
...
export const profileConfig: ProfileConfig = {
	avatar: "https://img.lwsnb.dpdns.org/file/1770349295364_IMG_20250823_144910_239.jpg", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "lws",
	bio: "一个普通的人",
	typewriter: {
...
export const commentConfig: CommentConfig = {
	...
	giscus: {
		repo: "lws666/lws666.github.io",
		repoId: "R_kgDOSJfTcw",
		category: "Announcements",
		categoryId: "DIC_kwDOSJfTc84C7bK6",
		mapping: "pathname",
		strict: "0",
		reactionsEnabled: "1",
		emitMetadata: "0",
